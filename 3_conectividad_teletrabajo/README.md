# Mapa 3: conectividad multitecnologia para teletrabajo e IA
...
La salida `salidas/mapa3_conectividad_teletrabajo_validacion_union.csv` resume el encaje municipal entre datos y geometria. En la ultima generacion: 8.131 municipios con dato, 1 geometria sin dato y 0 datos sin geometria.

## Ejecutar

```bash
/home/s/miniconda3/envs/VD/bin/python 3_conectividad_teletrabajo/mapa3_conectividad_teletrabajo.py
```

El script descarga los datos en `datos/` si no existen y genera:

- `salidas/mapa3_conectividad_teletrabajo.png`
- `salidas/mapa3_conectividad_teletrabajo.pdf`
- `salidas/mapa3_conectividad_teletrabajo_interactivo.html`
- `salidas/mapa3_conectividad_teletrabajo_datos.csv`
- `salidas/mapa3_conectividad_teletrabajo_validacion_union.csv`
